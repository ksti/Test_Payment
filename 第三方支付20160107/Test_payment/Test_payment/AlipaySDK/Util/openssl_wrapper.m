...
unsigned long rsa_sign_with_private_key_pem(char *message, unsigned long message_length
...
NSString *rsaSignString(NSString *stringToSign, NSString *privateKeyFilePath, BOOL *signSuccess)
{
    ...
    unsigned long sign_ok = rsa_sign_with_private_key_pem((char *)message, messageLength
                                                , sig, &sig_len
                                                , filePath);
